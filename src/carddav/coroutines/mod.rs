...
#[doc(inline)]
pub use self::{
    addressbook_home_set::AddressbookHomeSet, create_addressbook::CreateAddressbook,
    create_card::CreateCard, current_user_principal::CurrentUserPrincipal,
    delete_addressbook::DeleteAddressbook, delete_card::DeleteCard,
    list_addressbooks::ListAddressbooks, list_cards::ListCards, read_card::ReadCard, send::Send,
